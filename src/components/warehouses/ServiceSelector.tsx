              ...
              {selectedService && (
                <div className="mt-4 space-y-4">
                  <div>
                    ...
                    <select
                      value={selectedService.pricing_type}
                    ...
                    <div>
                      ...
                      <div className="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input
                          ...
                          min="0"
                          step="0.01"
                          value={selectedService.price_per_hour_cents ? selectedService.price_per_hour_cents / 100 : ''}
                          onChange={(e) => {
                      ...
                      <div>
                        ...
                        <div className="mt-1 grid grid-cols-2 gap-2">
                          ...
                          <input
                            ...
                            min="0"
                            step="0.01"
                            value={selectedService.price_per_unit_cents ? selectedService.price_per_unit_cents / 100 : ''}
                            onChange={(e) => {
                              const value = e.target.value === '' ? undefined : parseFloat(e.target.value);
                              onChange(selectedServices.map(s => 
                                s.id === service.id 
